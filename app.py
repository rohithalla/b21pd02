...
def table():
    ...
    return render_template('rec.html',nl=nl,pl=pl,kl=kl,templ=templ,huml=huml,moistl=moistl,phl=phl, predv = predv, cropeng=cropmatterenglish,ferteng=fertmatterenglish, lat=lat[-1], long1=long1[-1],dt=dt, td=td, cd=cd, rd=rd )
@app.route('/predplot')
def predplot():
